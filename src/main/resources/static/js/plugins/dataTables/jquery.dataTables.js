...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" class="'+classes.sFilterInput
			+'" placeholder="请输入检索账号" style="font-size:13px;width:160px;" id="acountSearch"/>';
		...
		str = str.match(/_INPUT_/) ?
			...
			str+input;
		var select = '查询：'
			+ '<select class="form-control" style="width:160px;margin-right:3px;' 
			+ 'font-size:13px;" id="cityList">'
		...
		var jqFilter = $('#cityList', filter)
			...
			.bind( 'onchange', function(e) {
				console.log(e);
			} )
			.attr('aria-controls', tableId);
			
		var jqFilter1 = $('input[type="search"]', filter)
			.val( previousSearch.sSearch.replace('"','&quot;') )
			.bind( 'keyup.DT search.DT input.DT paste.DT cut.DT', function(e) {
				/* Update all other filter input elements for the new display */
				var n = features.f;
