...
! function(e, t) {
	...
	! function(F) {
		...
		c.VERSION = "1.13.3", c.BootstrapVersion = _.major, c.DEFAULTS = {
				...
				j.each(function(e) {
					...
					if(R++, !t.hasClass("bs-title-option")) {
						var i, s, n = t.data(),
							...
							p = t.parent(),
							u = p[0],
							m = "OPTGROUP" === u.tagName,
							f = m && u.disabled,
							v = this.disabled || f,
							g = this.previousElementSibling && "OPTGROUP" === this.previousElementSibling.tagName,
							b = p.data();
						if(!0 === n.hidden || T.options.hideDisabled && (v && !m || f)) {
							i = n.prevHiddenIndex, t.next().data("prevHiddenIndex", void 0 !== i ? i : e), R--, g || void 0 !== i && (y = j[i].previousElementSibling) && "OPTGROUP" === y.tagName && !y.disabled && (g = !0), g && "divider" !== N[N.length - 1].type && (R++, D.push(M(!1, q.DIVIDER, A + "div")), N.push({
								type: "divider",
								optID: A
							}))
						} else {
							if(m && !0 !== n.divider) {
								...
								if(!this.previousElementSibling) {
									...
									var I = u.label,
										...
										$ = b.subtext,
										E = b.icon;
									0 !== e && 0 < D.length && (R++, D.push(M(!1, q.DIVIDER, A + "div")), N.push({
										type: "divider",
										optID: A
									})), R++;
									var S = function(e) {
									...
									D.push(M(S, "dropdown-header" + x, A)), N.push({
										content: k,
										subtext: $,
										type: "optgroup-label",
										optID: A
								...
								s = V({
									...
									optionSubtext: d,
									optionIcon: h
								}), D.push(M(U(s, "opt " + o + x, l), "", A)), N.push({
									content: r || c,
									subtext: d,
									tokens: a,
									type: "option",
							...
							} else if(!0 === n.divider) D.push(M(!1, q.DIVIDER)), N.push({
								type: "divider",
								originalIndex: e,
								data: n
							});
								...
								g && "divider" !== N[N.length - 1].type && (R++, D.push(M(!1, q.DIVIDER, A + "div")), N.push({
									type: "divider",
									optID: A
								})), s = V({
									text: c,
			...
			render: function() {
				...
				null == this.options.title && (this.options.title = this.$element.attr("title")), "static" == this.options.selectedTextFormat && (h = this.options.title), h || (h = void 0 !== this.options.title ? this.options.title : this.options.noneSelectedText), this.$button[0].title = m(h.replace(/<[^>]*>?/g, "").trim()), this.$button.find(".filter-option-inner-inner")[0].innerHTML = h, this.$element.trigger("rendered.bs.select")
			},
				...
				t.data("spaceSelect", !1), this.$button.on("keyup", function(e) {
					...
					if(E.multiple && 1 !== E.options.maxOptions && e.stopPropagation(), e.preventDefault(), !E.isDisabled() && !i.parent().hasClass(q.DISABLED)) {
						var c = E.$element.find("option"),
							...
							m = h.data("maxOptions") || !1;
						if(n === E.activeIndex && (t = !0), t || (E.prevActiveIndex = E.activeIndex, E.activeIndex = void 0), E.multiple) {
							if(a.prop("selected", !d), E.setSelected(n, !d), i.blur(), !1 !== u || !1 !== m) {
								var f = u < c.filter(":selected").length,
									v = m < h.find("option:selected").length;
								if(u && f || m && v)
									if(u && 1 == u) {
									...
									var w = "string" == typeof E.options.maxOptionsText ? [E.options.maxOptionsText, E.options.maxOptionsText] : E.options.maxOptionsText,
										x = "function" == typeof w ? w(u, m) : w,
										I = x[0].replace("{n}", u),
										k = x[1].replace("{n}", m),
										$ = F('<div class="notify"></div>');
									x[2] && (I = I.replace("{var}", x[2][1 < u ? 0 : 1]), k = k.replace("{var}", x[2][1 < m ? 0 : 1])), a.prop("selected", !1), E.$menu.append($), u && f && ($.append(F("<div>" + I + "</div>")), r = !1, E.$element.trigger("maxReached.bs.select")), m && v && ($.append(F("<div>" + k + "</div>")), r = !1, E.$element.trigger("maxReachedGrp.bs.select")), setTimeout(function() {
										E.setSelected(n, !1)
			...
			liveSearchListener: function() {
				...
				this.$button.on("click.bs.dropdown.data-api", function() {
					...
					if(u.selectpicker.search.map.newIndex = {}, u.selectpicker.search.map.originalIndex = {}, u.selectpicker.search.elements = [], u.selectpicker.search.data = [], e) {
						...
						u.activeIndex = void 0, u.noScroll = !0, u.$menuInner.scrollTop(0), u.selectpicker.search.elements = t, u.createView(!0), t.length || (m.className = "no-results", m.innerHTML = u.options.noneResultsText.replace("{0}", '"' + G(e) + '"'), u.$menuInner[0].firstChild.appendChild(m))
			...
			val: function(e) {
				return void 0 !== e ? (this.$element.val(e), this.render(), this.$element.trigger("changed.bs.select", y), y = null, this.$element) : this.$element.val()
			},
			...
			keydown: function(e) {
				var t, i, s, n, o, l = F(this),
					...
					m = c.isVirtual(),
					f = !0 === m ? c.selectpicker.view.position0 : 0;
				...
				i && (e.which === T && !c.selectpicker.keydown.keyHistory || e.which === O || e.which === D && c.options.selectOnTab) && (e.which !== T && e.preventDefault(), c.options.liveSearch && e.which === T || (c.$menuInner.find(".active a").trigger("click", !0), l.focus(), c.options.liveSearch || (e.preventDefault(), F(document).data("spaceSelect", !0))))
			},
			mobile: function() {
